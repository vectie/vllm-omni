...
| `vllm:omni_audio_chunk_rtf` | Histogram | — | Per-chunk delivery RTF (`delivery interval / playable chunk duration`); the first interval is TTFP and later intervals are packet-to-packet; uses `RTF_BUCKETS` |
