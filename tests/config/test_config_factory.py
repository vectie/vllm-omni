...
class TestDeployConfigLoading:
    ...
    def test_minicpmo_single_chip_exact_two_step_uses_sync_scheduler(
        self, monkeypatch
    ):
        monkeypatch.setenv(
            "VLLM_OMNI_MINICPMO45_TALKER_EXACT_TWO_STEP", "1"
        )
        pipeline = resolve_pipeline_config("minicpmo_4_5")
        assert isinstance(pipeline, PipelineConfig)
        deploy = _apply_platform_overrides(
...
class TestPlatformOverrides:
    ...
    def test_minicpmo_4_5_910c_cfm6_profile_changes_only_sampler_depth(self):
        deploy_path = Path(get_deploy_config_path("minicpmo_4_5_2npu_910c_cfm6.yaml"))
    ...
    def test_minicpmo_4_5_910c_cfm6_dit_mlp_graph_profile_is_explicit(self):
        deploy_path = Path(get_deploy_config_path("minicpmo_4_5_2npu_910c_cfm6_dit_mlp_graph.yaml"))
    ...
    def test_minicpmo_4_5_910c_thinker_c8_bounds_full_run_tail(self):
        deploy_path = Path(
            get_deploy_config_path("minicpmo_4_5_2npu_910c_cfm6_dit_mlp_graph_thinker_c8.yaml")
        )
    ...
    def test_minicpmo_4_5_910c_thinker_c5_targets_decode_tail(self):
        deploy_path = Path(
            get_deploy_config_path("minicpmo_4_5_2npu_910c_cfm6_dit_mlp_graph_thinker_c5.yaml")
        )
    ...
    def test_minicpmo_4_5_910c_thinker_c8_prefill16k_changes_only_stage0_budget(self):
        deploy_path = Path(
            get_deploy_config_path(
                "minicpmo_4_5_2npu_910c_cfm6_dit_mlp_graph_thinker_c8_prefill16k.yaml"
            )
        )
