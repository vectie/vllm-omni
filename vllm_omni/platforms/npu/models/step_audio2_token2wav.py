...
# The official one-device A/B showed that the larger Stage-2 bundle does not
# improve end-to-end RTF. Retain every HiFT implementation as an explicit
# experiment, but keep the evaluator path free of unqualified defaults.
_HIFT_DEFAULT_ENABLED_FLAGS: frozenset[str] = frozenset()
